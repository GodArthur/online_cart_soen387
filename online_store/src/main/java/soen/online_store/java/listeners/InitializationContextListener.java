...
//        
//        List<Product> testingcartProducts1 = new ArrayList<>();
//        testingcartProducts1.add(new Product("Blender", "High-speed countertop blender for smoothies and shakes", "KitchenTech", "blender-speedmaster", "SKU401", 59.99));
//        testingcartProducts1.add(new Product("Bicycle Helmet", "Adjustable helmet suitable for adults, safety-certified", "RideSafe", "helmet-adult", "SKU402", 24.49));
//
//        
//        List<Product> testingcartProducts2 = new ArrayList<>();
//        testingcartProducts2.add(new Product("Wireless Mouse", "Ergonomic wireless mouse with USB receiver", "TechGear", "mouse-wireless", "SKU404", 18.99));
//        testingcartProducts2.add(new Product("Garden Chair", "Foldable garden chair with armrests, green", "OutdoorLife", "chair-garden-green", "SKU405", 19.49));
//        
...
//
//        Cart cart3 = new Cart(testingcartProducts1,"3");
...
//
//        Cart cart5 = new Cart(testingcartProducts2,"5");
